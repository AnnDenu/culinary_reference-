<section>
    ...
    <form method="post" action="{{ route('password.update') }}" class="mt-6 space-y-6">
        ...
        <div>
            <x-input-label for="update_password_current_password" :value="__('Обновить пароль')" />
        ...
        <div>
            <x-input-label for="update_password_password_confirmation" :value="__('Повторить пароль')" />
